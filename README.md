...
> TODO update links to README.md#Setup
...
4. (a) First time only you have to sync manually all the `OutOfSync` applications
    * verify [guestbook](https://github.com/argoproj/argocd-example-apps/tree/master/guestbook) example with port forward and Ambassador
    ```bash
    ...
    ```
4. (b) *TODO First time only automatically sync all applications with a cronjob*
